...
interface props{
    ...
    itemClass?:string,
    items: item[],
    degree?: "360" | "180l" | "180r" | "180b" | "180t" |"bl"|"br",
    stagger?: number
}

export const FlowerNavigation = (
    {r=100, speed=0.2, className, items, degree="360", stagger=0.025}:props) => {
...
import { FlowerNavigation } from '@/components/ui/navs/flower'
