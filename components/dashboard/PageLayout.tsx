        ...
        <div className='flex flex-col gap-4 w-full md:max-w-[820px]'> 
            ...
            <div>
...

                    {
                       ...
                       <div className="flex flex-col mt-4 gap-4">
                        <h1 className="text-2xl">Other Varaints</h1>
                            {
                                 variants.map((vari, i) => 
                                    <div className="flex flex-col gap-4" key={i}>
                                         <h2>With props <span className='p-2 rounded-md bg-[var(--secondary)]'>{vari.prop}</span></h2>
                                         <div className={('p-[10px] w-full bg-[var(--secondary)] transition-all duration-300 @container mx-auto border border-col rounded-[16px] md:p-4')}>
                                             {/* <div className='p-2 flex-center gap-2 '>
                                                 <span className='w-3 h-3 rounded-full bg-amber-500'></span>
                                                 <span className='w-3 h-3 rounded-full bg-green-500'></span>
                                                 <span className='w-3 h-3 rounded-full bg-red-500'></span>
...

                        {
                            ...
                            <div className='w-full h-20 rounded-md relative'>
                                <CopyButton 
                                animationVariant={2}
                                className='absolute top-3 right-[2px] clickable p-1 px-0 w-8 flex items-center justify-center rounded-md'/>
...

                        {
                            ...
                            <div className='w-full p-[10px] bg-[var(--secondary)] border border-col rounded-[16px]'>
                                ...
                                bg-[var(--bg)] border border-col relative rounded-[6px] w-full'>
                                    ...
                                    <div className='p-[1px] flex-center absolute top-2 right-2 w-fit rounded-md bg-[var(--secondary)] gap-2'>
                                    ...
                                    <div className={cn('h-full overflow-hidden', type !== "Pro" && "overflow-y-scroll")}>
                       ...
                       <div ref={container4} className='w-full flex items-center justify-center'>
                             <ReportBug id="main">
